...
const pianoVoicings = {
  ...
  'F':   { notes: ['F3','A3','C4'],   bass: 'F3'  },
  'F#':  { notes: ['F#3','A#3','C#4'],bass: 'F#3' },
  'G':   { notes: ['G3','B3','D4'],   bass: 'G3'  },
  'G#':  { notes: ['G#3','C4','D#4'], bass: 'G#3' },
  'A':   { notes: ['A3','C#4','E4'],  bass: 'A3'  },
  'A#':  { notes: ['A#3','D4','F4'],  bass: 'A#3' },
  'B':   { notes: ['B3','D#4','F#4'], bass: 'B3'  },
  // ─── MINOR ──────────────────────────────────────────────────────────────────
  ...
  'Fm':  { notes: ['F3','Ab3','C4'],  bass: 'F3'  },
  'F#m': { notes: ['F#3','A3','C#4'], bass: 'F#3' },
  'Gm':  { notes: ['G3','Bb3','D4'],  bass: 'G3'  },
  'G#m': { notes: ['G#3','B3','D#4'], bass: 'G#3' },
  'Am':  { notes: ['A3','C4','E4'],   bass: 'A3'  },
  'A#m': { notes: ['A#3','C#4','F4'], bass: 'A#3' },
  'Bm':  { notes: ['B3','D4','F#4'],  bass: 'B3'  },
  // ─── DIMINISHED ─────────────────────────────────────────────────────────────
  ...
  'Fdim':  { notes: ['F3','Ab3','B3'],   bass: 'F3'  },
  'F#dim': { notes: ['F#3','A3','C4'],   bass: 'F#3' },
  'Gdim':  { notes: ['G3','Bb3','Db4'],  bass: 'G3'  },
  'G#dim': { notes: ['G#3','B3','D4'],   bass: 'G#3' },
  'Adim':  { notes: ['A3','C4','Eb4'],   bass: 'A3'  },
  'A#dim': { notes: ['A#3','C#4','E4'],  bass: 'A#3' },
  'Bdim':  { notes: ['B3','D4','F4'],    bass: 'B3'  },
}
